...
export default function CharacterSelector({ characters, onSelect, userName, loading, character }) {
  ...
  return (
    <motion.div 
      className="min-h-[calc(100vh-4rem)] flex flex-col items-start justify-start p-4 sm:p-6 md:p-8 lg:p-12 pt-8 bg-white dark:bg-gray-900"
    ...
    >
      <div className="w-full">
        ...
        >
          <motion.h1 
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 text-blue-600 dark:text-blue-400"
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
            ...
            {characters.map((char, index) => (
              ...
              >
                <Card
                  ...
                  tabIndex={0}
                  role="button"
                  className="cursor-pointer h-full min-h-[200px] flex flex-col justify-center hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-pink-500/30 transition-all duration-500 bg-white dark:bg-gray-800 border-2 border-pink-200 dark:border-pink-500 hover:border-pink-400 dark:hover:border-pink-400 rounded-3xl overflow-hidden group relative w-full max-w-[300px]"
                >
                  {/* Animated sparkles */}
                  <motion.div 
                  ...
                  <div className="absolute inset-0 bg-pink-100/20 dark:bg-pink-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  ...
                  <CardContent className="text-center pt-0 relative z-10">
                    ...
                    >
                      ...
                      <p className="text-base text-gray-700 dark:text-gray-200 font-medium">
                        Expert in <span className="font-bold text-pink-600 dark:text-pink-400">{char.subject}</span>
                      </p>
                    </motion.div>
                    <motion.div 
